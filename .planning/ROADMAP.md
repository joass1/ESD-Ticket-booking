...
Plans:
- [x] 02-01-PLAN.md -- Event Service CRUD endpoints and Booking Service query endpoints
- [x] 02-02-PLAN.md -- Seat Service with Redis dual-lock concurrency control and auto-assignment
- [ ] 02-03-PLAN.md -- Integration tests for all three foundation services
...
Plans:
- [ ] 03-01-PLAN.md -- Payment Service (Stripe PaymentIntent) and Booking Orchestrator (saga state machine, compensating transactions, APScheduler, AMQP publishing)
- [ ] 03-02-PLAN.md -- Ticket Service (AMQP consumer, QR generation, WebSocket delivery, HTTP fallback) and integration tests
...
| 2. Foundation Services | 2/3 | In Progress | - |
| 3. Booking Saga | 1/2 | In Progress|  |
